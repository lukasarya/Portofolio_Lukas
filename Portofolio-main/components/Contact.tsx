          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                ...
                <h3 className="font-semibold text-white mb-1">{t.contact.phone[lang]}</h3>
                <p className="text-sm text-dark-400">+62 858-1338-0763</p>
              </a>
              ...
              >
                ...
                <h3 className="font-semibold text-white mb-1">{t.contact.email[lang]}</h3>
                <p className="text-sm text-dark-400">aryalukas65@gmail.com</p>
              </a>
              ...
              >
                ...
                <h3 className="font-semibold text-white mb-1">{t.contact.linkedin[lang]}</h3>
