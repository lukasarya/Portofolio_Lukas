    ...
    <section id="experience" className="bg-white dark:bg-dark-900">
      <div className="section-container">
        ...
        <div className="max-w-4xl mx-auto relative">
          <div className="absolute left-4 sm:left-6 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary-500 via-primary-600 to-transparent" />

          {exps.map((exp, index) => (
            <Reveal key={index} delay={index * 120} className="relative pl-12 sm:pl-16 pb-12 last:pb-0">
              <div className="absolute left-2 sm:left-3 w-5 h-5 bg-primary-500 rounded-full border-4 border-white dark:border-dark-900 shadow-lg ring-4 ring-primary-500/20 animate-scale-pulse" />
              <TiltCard tiltIntensity={8}>
                <div className="card p-6 sm:p-8 hover-lift">
