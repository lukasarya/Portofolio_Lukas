        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          {exps.map((exp, index) => (
            <Reveal key={index} delay={index * 120} className="relative pl-12 sm:pl-16 pb-12 last:pb-0">
              <div className="absolute left-2 sm:left-3 w-5 h-5 bg-primary-500 rounded-full border-4 border-dark-900 shadow ring-4 ring-primary-500/20" />
              <div className="card p-6 sm:p-8 hover:-translate-y-1 transition-transform duration-300">
                <div className="flex items-start gap-4">
                  <div className="shrink-0 w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-white border border-dark-700 flex items-center justify-center p-1.5 shadow overflow-hidden">
                    {(exp as any).logoImg ? (
                      <img
                  ...
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2 mb-2">
                      ...
                      <h3 className="text-lg font-semibold text-white">{exp.role[lang]}</h3>
                    </div>
