  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-white via-gray-50 to-white dark:from-dark-900 dark:via-dark-800 dark:to-dark-900">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-20 left-10 w-20 h-20 border-2 border-primary-300/30 dark:border-primary-500/30 rounded-lg animate-spin-slow" />
        <div className="absolute bottom-20 right-10 w-32 h-32 border-2 border-purple-300/30 dark:border-purple-500/30 rounded-full animate-spin-slow" style={{ animationDelay: '5s' }} />
        <div className="absolute top-1/2 right-20 w-16 h-16 bg-gradient-to-br from-pink-400/20 to-purple-400/20 rounded-lg rotate-45 animate-bounce-subtle" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight mb-6 animate-fade-up" style={{ animationDelay: '120ms' }}>
              <span className="gradient-text">{t.hero.title[lang]}</span>
            </h1>
          ...
          <div className="relative animate-scale-in" style={{ animationDelay: '300ms' }}>
            <TiltCard tiltIntensity={15}>
              <div className="max-w-md mx-auto relative animate-float">
                <div className="absolute -inset-6 bg-gradient-to-br from-primary-500 to-primary-700 rounded-full blur-2xl opacity-30 dark:opacity-20 animate-glow" />
            ...
            <TiltCard tiltIntensity={8}>
              <div className="mt-6 bg-white dark:bg-dark-800 rounded-2xl shadow-xl p-5 border border-gray-200 dark:border-dark-700 animate-fade-up hover-lift" style={{ animationDelay: '700ms' }}>
                <div className="grid grid-cols-2 gap-3">
                  {statsArr.map((s: any, i: number) => (
                    <div key={i} className="bg-primary-50 dark:bg-primary-900/40 p-3 rounded-xl text-center hover:scale-110 transition-transform">
            ...
            <TiltCard tiltIntensity={12}>
              <div className="mt-4 bg-white dark:bg-dark-800 p-3 rounded-xl shadow-lg border border-gray-200 dark:border-dark-700 animate-fade-up hover-lift" style={{ animationDelay: '800ms' }}>
        ...
        <div className="mt-20 text-center animate-fade-in" style={{ animationDelay: '1s' }}>
          <a href="#about" className="inline-flex items-center gap-2 text-gray-400 dark:text-dark-500 hover:text-primary-600 dark:hover:text-primary-400 transition-colors animate-bounce-subtle">
